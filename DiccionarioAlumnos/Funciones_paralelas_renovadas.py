...
def mostrar_alumno(un_alumno:dict):
    print(f"  {un_alumno["legajo"]}     {un_alumno["nombre"]}{un_alumno["genero"]}{un_alumno["nota_p1"]}{un_alumno["nota_p2"]}   {un_alumno["promedio"]}") 
...
def new_alumno(legajo, nombre, genero, nota_p1, nota_p2)->dict:
    nuevo_alumno = {}
    nuevo_alumno["legajo"] = legajo
    nuevo_alumno["nombre"] = nombre
    nuevo_alumno["genero"] = genero
    nuevo_alumno["nota_p1"] = nota_p1
    nuevo_alumno["nota_p2"] = nota_p2
    nuevo_alumno["promedio"]= calcular_promedio(nota_p1, nota_p2)
    return nuevo_alumno
